        ...
        <div>
            ...
            <Dialog open={open} onClose={handleCloseDialog}>
                ...
                <DialogContent>
                    ...
                    />
                    <Autocomplete renderInput={(params) => <TextField {...params} label="media Type"/>} options={
                        [
                            {
                    ...
                    {
                        mediaType === 'video' ?
                            <TextField label='Question video URL' fullWidth={true} type={'url'}
                                       margin={"normal"}
                                       InputLabelProps={{
                                           shrink: true,
                                       }}
                                       onChange={
                                           (event) => {
                                               console.log(event.target.value);
                                               setQuestion({...question, image: event.target.value});
                                           }
                                       }
                            /> :
...
function OptionInput(props) {
    ...
    return (
        <Box component={"div"} sx={
            ...
            <Autocomplete renderInput={(params) => <TextField {...params} label="Answer"/>}
                          options={
                              [
