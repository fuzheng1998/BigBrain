...
SingleQuestionEdit.propTypes = {
  questionId: PropTypes.number,
  singleQuestion: PropTypes.object,
  fullGame: PropTypes.object,
...
function SingleQuestionEdit (props) {
  ...
  const handleQuestionEdit = () => {
    navigate('../admin/edit/' + gameId + '/question/' + questionId, {
      state: {
...
QuestionAddFormDialog.propTypes = {
  open: PropTypes.bool,
  ...
  return (
        <Box component={'div'} sx={
            ...
            <Autocomplete
                ...
                onChange={
                    (event, value) => {
                      const tempProps = { ...props.question };
                      if (value.answer) {
                        // Received True
